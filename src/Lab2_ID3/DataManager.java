...
/**
 * The Lab2_ID3.DataManager class is used to convert the string data loaded in from the text file
 * to Lab2_ID3.Mushroom objects.
 * The Lab2_ID3.DataManager class makes use of the Lab2_ID3.Main class to accomplish this.
 */
